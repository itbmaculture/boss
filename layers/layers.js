...
var format_SportField_A_4 = new ol.format.GeoJSON();
var features_SportField_A_4 = format_SportField_A_4.readFeatures(json_SportField_A_4, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_SportField_A_4 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_SportField_A_4.addFeatures(features_SportField_A_4);
var lyr_SportField_A_4 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_SportField_A_4, 
                style: style_SportField_A_4,
                popuplayertitle: "SportField_A",
                interactive: true,
                title: '<img src="styles/legend/SportField_A_4.png" /> SportField_A'
            });

lyr_GoogleSatellite_0.setVisible(true);lyr_GoogleMap_1.setVisible(true);lyr_district_2.setVisible(true);lyr_bma_zone_3.setVisible(true);lyr_SportField_A_4.setVisible(true);
var layersList = [lyr_GoogleSatellite_0,lyr_GoogleMap_1,lyr_district_2,lyr_bma_zone_3,lyr_SportField_A_4];
...
lyr_SportField_A_4.set('fieldAliases', {'ID': 'ID', 'dcode': 'dcode', 'district': 'district', 'objectid': 'objectid', 'grade': 'grade', 'name': 'name', 'ownership': 'ownership', 'type_': 'type_', 'status': 'status', 'volunteer': 'volunteer', 'renovate_s': 'renovate_s', 'status_oth': 'status_oth', 'activity': 'activity', 'budget': 'budget', 'sport': 'sport', 'lat': 'lat', 'long': 'long', 'sport_othe': 'sport_othe', 'public_space': 'public_space', 'renovate_detail': 'renovate_detail', 'area_': 'area_', 'status_confirm': 'status_confirm', 'user_': 'user_', 'budget_other': 'budget_other', 'contract1': 'contract1', 'contract2': 'contract2', 'contract3': 'contract3', 'x': 'x', 'y': 'y', });
